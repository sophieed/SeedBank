...
/**
 * Tests the ValidationFailure views
 */
public class TestValidationFailureViews extends ApplicationTest {
	...
	public void start (Stage stage) throws Exception {
		FXMLLoader fxmlLoader = new FXMLLoader(
				getClass().getResource("/fxml/popups/ValidationFailure.fxml"));
	...
	public void testDisplay() {
		...
		Platform.runLater(new Runnable() {
			@Override
			public void run() {
				verifyThat("#causeOfFailure", isVisible());
